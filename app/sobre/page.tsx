  ...
  return (
    <div className="min-h-screen bg-basalt text-porcelain selection:bg-signal-blue selection:text-void">
      ...
      <main id="conteudo" className="overflow-hidden">
        ...
        >
          <div className="relative min-h-56 overflow-hidden border-b border-porcelain/12 bg-signal-deep/10 p-6 sm:p-10 lg:col-span-5 lg:min-h-[460px] lg:border-b-0 lg:border-r lg:p-12">
            <div
              aria-hidden="true"
              className="absolute -left-20 top-1/2 h-64 w-64 -translate-y-1/2 rotate-45 border border-signal-blue/45"
            />
            <div
              aria-hidden="true"
              className="absolute -left-8 top-1/2 h-40 w-40 -translate-y-1/2 rotate-45 bg-signal-blue/10"
            />
            <div className="relative flex h-full flex-col justify-between gap-20">
              <span className="font-sans text-[10px] font-medium uppercase tracking-[0.16em] text-mineral">
                Tese / campo de trabalho
              </span>
              <p className="max-w-xs font-sans text-xs font-medium uppercase leading-relaxed tracking-[0.12em] text-mineral">
          ...
          <div className="border-b border-porcelain/12 p-6 sm:p-10 lg:col-span-7 lg:border-b-0 lg:p-12 xl:p-16">
            <p className="mb-8 font-sans text-[10px] font-medium uppercase tracking-[0.16em] text-node-gold">
              Nossa convicção
            </p>
            <h2
              id="tese-heading"
              className="max-w-4xl font-display text-3xl font-medium leading-[1.08] tracking-[-0.035em] sm:text-5xl lg:text-6xl"
            >
              Tecnologia só vira valor quando arquitetura e percepção
              trabalham como uma peça única.
            </h2>
            <div className="mt-10 grid gap-6 border-t border-porcelain/12 pt-8 text-sm leading-7 text-mineral sm:grid-cols-2 sm:text-base">
              <p>
        ...
        <section
          ...
          className="mx-auto w-full max-w-[1440px] border-x border-t border-porcelain/12"
        >
          <div className="grid border-b border-porcelain/12 lg:grid-cols-12">
            ...
            <div className="p-6 pt-0 sm:p-10 sm:pt-0 lg:col-span-8 lg:p-12">
              <h2
                ...
                className="max-w-3xl font-display text-3xl font-medium tracking-[-0.03em] sm:text-4xl"
              >
          ...
          <div className="grid md:grid-cols-2">
            {principles.map((principle, index) => (
              <article
                key={principle.code}
                className={`group min-h-72 border-b border-porcelain/12 p-6 transition-colors duration-300 hover:bg-signal-deep/15 sm:p-10 lg:p-12 ${
                  index % 2 === 0 ? "md:border-r" : ""
                }`}
              >
                <div className="flex items-center justify-between">
                  <span className="font-sans text-[10px] font-medium tabular-nums tracking-[0.14em] text-mineral">
                    {principle.code}
                  </span>
                  <span
                    aria-hidden="true"
                    className="h-2 w-2 rotate-45 border border-node-gold transition-transform duration-300 group-hover:rotate-[135deg] group-hover:bg-node-gold"
                  />
                </div>
                <h3 className="mt-16 font-display text-2xl font-medium tracking-[-0.02em] sm:text-3xl">
                  {principle.title}
                </h3>
                <p className="mt-4 max-w-xl text-sm leading-7 text-mineral sm:text-base">
                  {principle.text}
                </p>
              </article>
            ))}
        ...
        <section
          ...
          className="mx-auto w-full max-w-[1440px] border-x border-porcelain/12 py-20 sm:py-28"
        >
          <div className="px-6 sm:px-10 lg:px-12">
            ...
            <h2
              id="processo-heading"
              className="mt-5 max-w-3xl font-display text-4xl font-medium leading-tight tracking-[-0.04em] sm:text-5xl"
            >
              Quatro passagens. Um único sistema de decisão.
            </h2>
          </div>

          <ol className="mt-16 border-t border-porcelain/12">
            {process.map((step) => (
              <li
                key={step.number}
                className="group grid border-b border-porcelain/12 px-6 py-8 transition-colors hover:bg-signal-deep/15 sm:px-10 lg:grid-cols-12 lg:items-start lg:px-12"
              >
                <span className="font-sans text-2xl font-medium tabular-nums text-signal-blue lg:col-span-2">
                  {step.number}
                </span>
                <h3 className="mt-5 font-display text-2xl font-medium tracking-[-0.02em] sm:text-3xl lg:col-span-3 lg:mt-0">
                  {step.title}
                </h3>
                <p className="mt-4 max-w-xl text-sm leading-7 text-mineral sm:text-base lg:col-span-5 lg:mt-0 lg:pr-8">
                  {step.text}
                </p>
                <p className="mt-6 border-l border-signal-blue pl-4 font-sans text-[10px] font-medium uppercase leading-5 tracking-[0.14em] text-mineral lg:col-span-2 lg:mt-0">
                  Entrega
                  <br />
                  <span className="text-porcelain">{step.output}</span>
                </p>
              </li>
            ))}
          </ol>
        ...
        <section className="border-y border-porcelain/12 bg-porcelain text-void">
          <div className="mx-auto grid w-full max-w-[1440px] lg:grid-cols-12">
            <div className="border-b border-void/15 p-6 sm:p-10 lg:col-span-8 lg:border-b-0 lg:border-r lg:p-12 xl:p-16">
              <p className="font-sans text-[10px] font-medium uppercase tracking-[0.16em] text-signal-deep">
                Próximo campo
              </p>
              <h2 className="mt-6 max-w-4xl font-display text-4xl font-medium leading-[1.04] tracking-[-0.045em] sm:text-6xl">
                Traga o problema.
                <br />
            ...
            <div className="flex items-end p-6 sm:p-10 lg:col-span-4 lg:p-12">
              <Link
                href="/contato"
                className="group flex w-full items-center justify-between border-t border-void py-5 text-sm font-medium uppercase tracking-[0.1em] outline-none transition-colors hover:text-signal-blue focus-visible:ring-2 focus-visible:ring-signal-blue focus-visible:ring-offset-4 focus-visible:ring-offset-porcelain"
              >
                Abrir uma conversa
                <ArrowUpRight
                  aria-hidden="true"
