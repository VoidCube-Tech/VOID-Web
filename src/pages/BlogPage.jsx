...
export default function BlogPage() {
  ...
  usePageMeta('VOID/LOG — Ideias, sistemas e trabalho real', 'Arquitetura, automação, integrações, projetos e decisões de engenharia da Void Systems.')

  return <div className="inner-page blog-page">
    <section className="inner-hero" data-header-theme="dark"><span className="kicker">VOID/LOG</span><h1>Ideias, sistemas<br/>e trabalho real.</h1><p>Arquitetura, automação, integrações, projetos e decisões de engenharia.</p><div className="hero-flow-line" aria-hidden="true" /></section>
